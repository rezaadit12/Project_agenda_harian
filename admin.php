                        ...
                        <li class="nav-item dropdown">
                            <button class="btn logoItem " data-bs-toggle="dropdown" aria-expanded="false">
                                <button class="btn logoItem " data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <img class="imgUser" src="img/photo-profile-default-circle.svg" width="40"
                                        id="user-image">
                                </button>
                            </button>
        ...
        <table class=" table table-responsive  table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="250">
                        <a href="/" data-id="<?= $dataUser['id']?>" class="tampilModalUbahAdmin" data-bs-toggle="modal"
                            data-bs-target="#exampleModal"><i class="fa-solid fa-pen-to-square"></i> Update</a> |
                        <a href="detail.php?id=<?= $dataUser['id']?>" class="link-warning"><i
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="judul" name="judul_kegiatan" required
                                        autocomplete="off"><br>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="kegiatan" class="form-control" id="kegiatan" cols="30" rows="2"
                                        placeholder="(Tidak Wajib)"></textarea><br>
                                </div>
                                <div class="form-group">
                                    <div class="form-label"><b>Tanggal :</b></div>
                                    <input type="date" class="form-control" id="tanggal" name="tanggal_kegiatan"
